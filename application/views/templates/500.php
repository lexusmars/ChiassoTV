        ...
        <div class="row">
            <div class="col d-table">
                <div class="text-center d-table-cell align-middle wow slideInDown vh-100">
                    ...
                    <h4 class="h4-responsive text-white">C'è un problema interno in questo momento. Stiamo lavorando per risolvere il problema...</h4>
                    <h5 class="btn btn-danger mt-4">- Team di ChiassoTV</h5>
                </div>
            </div>
        </div>
    </div>
